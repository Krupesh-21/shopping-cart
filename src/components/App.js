...
const App = ({ selectedCategoryProduct }) => {
  return (
    <div>
      <Router>
        <Header />
        <Switch>
          ...
          />
          <Route
            path="/purchase/:id/:useremail" exact
            render={(props) => <PlaceOrder {...props} />}
          />
          <Route
            path="/purchase/:useremail" exact
            render={(props) => <PlaceOrder {...props} />}
          />
          <Route
            ...
            exact
            render={() => (
              <Category selectedCategoryProduct={selectedCategoryProduct} />
            )}
          />
          <Route
